...
function Step3({ onDone }) {
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <button style={S.primaryBtn} onClick={onDone}>Start Creating rides</button>
    </div>
  );
}

const STEP_META = [
  { badge: "1/3", icon: "👤", title: "Create Driver Account", sub: "Let's get to know you better" },
  { badge: "2/3", icon: "📱", title: "Verify your number", sub: "Enter the OTP we just sent you" },
  { badge: "3/3", icon: "✅", title: "You're all set", sub: "" },
];

export default function CreateDriverModal({ onClose, onLogin, onDone }) {
