...
const PreferenceCard = ({ icon: Icon, title, description, children, twoColumn }) => (
  <div style={{ backgroundColor: colors.white, borderRadius: 12, padding: '20px 24px', border: `1px solid ${colors.border}`, boxShadow: '0 2px 8px rgba(0,0,0,0.05)', gridColumn: twoColumn ? 'span 2' : 'span 1' }}>
    ...
    <div style={{ minHeight: '100vh', backgroundColor: colors.lightGray, fontFamily: "'Inter', sans-serif" }}>
      <div style={{ backgroundColor: colors.white, borderBottom: `1px solid ${colors.border}`, position: 'sticky', top: 0, zIndex: 10, boxShadow: '0 1px 8px rgba(0,0,0,0.05)' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '16px 24px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
            <button onClick={() => navigate('/offer-ride')} style={{ background: 'none', border: 'none', padding: 8, cursor: 'pointer', display: 'flex', alignItems: 'center' }}><ChevronLeft style={{ width: 24, height: 24 }} /></button>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '32px 24px' }}>
        <div style={{ marginBottom: 32 }}>
          <h2 style={{ fontSize: 32, fontWeight: 800, color: colors.navy, marginBottom: 8 }}>Ride <span style={{ color: colors.teal }}>Preferences</span></h2>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <button onClick={() => navigate('/offer-ride')} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '12px 24px', border: `1.5px solid ${colors.border}`, borderRadius: 10, fontSize: 15, fontWeight: 600, color: colors.navy, backgroundColor: colors.white, cursor: 'pointer' }}>
